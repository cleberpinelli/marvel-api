package pinelli.marvelapi.api.http.advices;
...
import pinelli.marvelapi.domain.exception.BusinessException;
import pinelli.marvelapi.domain.exception.NotFoundException;
import pinelli.marvelapi.domain.exception.ValidationException;
